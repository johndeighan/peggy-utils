// peggify.coffee
var byteCodeWriter, fileName, filePath, generate, jsCode, lMatches, opDumper, outFilePath, peggyCode, pkg, stub;
...
import {
  OpDumper
} from '@jdeighan/peggy-utils/OpDumper';

import {
  ByteCodeWriter
} from '@jdeighan/peggy-utils/ByteCodeWriter';
...
peggyCode = fs.readFileSync(filePath, 'utf8').toString().replaceAll('\r', '');

byteCodeWriter = new ByteCodeWriter(stub, {
  detailed: false
});
