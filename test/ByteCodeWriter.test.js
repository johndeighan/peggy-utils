...
test("line 9", (t) => {
  ...
  return t.deepEqual(bcw.getOpInfo(35), ['PUSH_EMPTY_STRING', [], []]);
});
...
test("line 22", (t) => {
  ...
  return t.is(bcw.getBlock(), `<start>
	RULE <#1>
	IF_ERROR
		POP
		RULE <#2>`);
...
test("line 56", (t) => {
  ...
  return t.is(bcw.getBlock(), `<first>
	MATCH_STRING 'abc'
		ACCEPT_STRING 'abc'
	ELSE
		FAIL "abc"`);
...
test("line 90", (t) => {
  ...
  return t.is(bcw.getBlock(), `<second>
	MATCH_STRING 'def'
		ACCEPT_STRING 'def'
	ELSE
		FAIL "def"`);
